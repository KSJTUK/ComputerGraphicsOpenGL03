...
{
		gl_Position = perspectiveMat * viewMat * (gl_in[index].gl_Position + vec4(-primitiveSize, primitiveSize, 0.0f, 0.0f));
...
{
	gl_Position = perspectiveMat * viewMat * (gl_in[index].gl_Position + vec4(-primitiveSize, 0.0f, 0.0f, 0.0f));
	...
	gl_Position = perspectiveMat * viewMat * (gl_in[index].gl_Position + vec4(0.0f, -primitiveSize, 0.0f, 0.0f));
